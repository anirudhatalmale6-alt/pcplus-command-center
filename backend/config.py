...
CRASHPLAN_BASE_URL = os.getenv("CRASHPLAN_BASE_URL", "https://console.us1.crashplan.com")
CRASHPLAN_CLIENT_ID = os.getenv("CRASHPLAN_CLIENT_ID", "key-1128386f-5633-47d8-845e-fcb80c388abf")
CRASHPLAN_CLIENT_SECRET = os.getenv("CRASHPLAN_CLIENT_SECRET", "Mqzqjcny6bmmRCbcNsmybxxNK@LNLJbVGcDNbMzx")

THREECX_URL = os.getenv("THREECX_URL", "https://pcpluscomputing51.my3cx.ca")
THREECX_USER = os.getenv("THREECX_USER", "computerfixguy@hotmail.com")
THREECX_PASS = os.getenv("THREECX_PASS", "$#2623Cook1940??")
